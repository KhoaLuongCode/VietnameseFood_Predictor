...
function Selection({mindmapRef}) {
    ...
    const foodImageMapping = {
      "Banh Bao": "/Banh Bao.jpeg",
      "Banh Canh": "/Banh Canh.jpeg",
      "Banh Cuon": "/Banh Cuon.jpeg",
      "Banh Mi": "/Banh My.jpeg",
      "Banh Tom": "/Banh Tom.jpeg",
      "Banh Trang Tron": "/Banh Trang Tron.jpeg",
      "Banh Xeo": "/Banh Xeo.jpeg",
      "Bun Bo Hue": "/Bun Bo Hue.jpeg",
      "Bun Bo Nam Bo": "/Bun Bo Nam Bo.webp",
      "Bun Cha": "/Bun Cha.jpeg",
      "Bun Moc": "/Bun Moc.jpeg",
      "Bun Rieu": "/Bun Rieu.jpeg",
      "Bun Thit Nuong": "/Bun Thit Nuong.webp",
      "Ca Phe Sua Da": "/Ca Phe Sua Da.jpeg",
      "Cha Gio": "/Cha Gio.jpeg",
      "Cao Lau": "/Cao Lau.jpeg",
      "Che": "/Che .jpeg",
      "Com Tam": "/Com Tam.jpeg",
      "Goi Cuon": "/Goi Cuon.jpeg",
      "Goi Xoai": "/Goi Xoai.jpeg",
      "Hu Tieu": "/Hu Tieu.jpeg",
      "Hu Tieu Nam Vang": "/Hu Tieu Nam Vang.jpeg",
      "Lau Viet Nam": "/Lau Viet Nam.jpeg",
      "My Quang": "/My Quang.jpeg",
      "Nem Nuong": "/Nem Nuong.jpeg",
      "Pho": "/Pho.jpeg",
      "Non La": "/Non La.png",
    };
        ...
        <Box >
            <Box sx={{paddingLeft: '70px', paddingRight: '70px', fontFamily: 'QuickSand', marginTop: '-50px'}}>
                ...
                <Grid container spacing={2}>
                    <Grid item xs={4}>
                        <Box sx={{...mainBoxStyle}}>
                            <img src="/MainIngredient.png" alt="Main Ingredient" style={{width: '100px', height: '130px', justifyContent:'center', display:'flex'}}/>
                    ...
                    <Grid item xs={4}>
                        <Box sx={{...mainBoxStyle}}>
                            <img src="/vietnam-drip.png" alt="Rice Dish"
                    ...
                    <Grid item xs={4}>
                        <Box sx={{...mainBoxStyle}}>
                            <img src="/rice.png" alt="Rice Dish"
                ...
                <Grid container spacing={2}>
                    <Grid item xs={4}>
                        <Box sx={{...mainBoxStyle}}>
                            <img src="/goi-cuon.png" alt="Rice Dish"
                                 style={{width: '100px', height: '130px', justifyContent: 'center', display: 'flex'}}/>
                    ...
                    <Grid item xs={4}>
                        <Box sx={{...mainBoxStyle}}>
                            <img src="/chopstick.png" alt="Rice Dish"
                                 style={{width: '100px', height: '130px', justifyContent: 'center', display: 'flex'}}/>
                    ...
                    <Grid item xs={4}>
                        <Box sx={{...mainBoxStyle}}>
                            <img src="/banh-mi.png" alt="Rice Dish"
                                 style={{width: '100px', height: '130px', justifyContent: 'center', display: 'flex'}}/>
